...
function insertDetail(element) {
    ...
    var theURL="http://money.finance.sina.com.cn/d/api/openapi_proxy.php/?__s=[[%22jg_detail%22,%22"+stockCode+"%22,%22%E5%85%A8%E5%9B%BD%E7%A4%BE%E4%BF%9D%E5%9F%BA%E9%87%91%22,%22"+s_rd+s_q+"%22]]";
...
function createDetailTable(data){
    var detailTableStr="<tr class='detailTr'>";
        ...
        detailTableStr+="               <tr>";
        detailTableStr+="                   <td>社保代码</td>";
        detailTableStr+="                   <td>社保名称</td>";
...
function beginSearch(index){
    ...
    FDC_DC.blocks[index].param="[%22jg%22,%22"+stockCode.slice(2)+"%22,%22全国社保基金%22,%22"+s_rd+s_q+"%22,{page},{num}]";
