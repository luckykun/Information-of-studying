...
function beginSearch(index){
    ...
    var s_type=$("#s_type option:selected").attr("value");
    ...
    FDC_DC.blocks[0].param="[%22yjyg%22,%22"+s_i+"%22,%22"+s_a+"%22,%22"+s_c+"%22,%22"+s_type+"%22,%22"+s_rd+"%22,"+s_q+",%22{sort}%22,{asc},{page},{num}]";
