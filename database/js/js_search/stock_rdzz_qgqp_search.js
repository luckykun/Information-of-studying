$(document).ready(function(){
    ...
    //setInterval(function(){
        ...
        FDC_DC.blocks[0].param="[%22qgqp%22,%22"+s_i+"%22,%22"+s_a+"%22,%22"+s_c+"%22,%22"+s_t+"%22,%22"+s_z+"%22,%22{sort}%22,{asc},{page},{num}]";
...
function dealSelect(index){
    ...
    FDC_DC.blocks[index].param="[%22qgqp%22,%22"+s_i+"%22,%22"+s_a+"%22,%22"+s_c+"%22,%22"+s_t+"%22,%22"+s_z+"%22,%22{sort}%22,{asc},{page},{num}]";
...
function beginSearch(index){
    ...
    FDC_DC.blocks[index].param="[%22qgqp_symbol%22,%22"+stockCode.slice(2)+"%22,%22{sort}%22,{asc},{page},{num}]";
